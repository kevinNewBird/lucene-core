...
public class CharArrayMap<V> extends AbstractMap<Object,V> {
  ...
  public String toString() {
    ...
    for (Entry<Object,V> entry : entrySet()) {
  ...
  private final class MapEntry implements Entry<Object,V> {
  ...
  public final class EntrySet extends AbstractSet<Entry<Object,V>> {
    private final boolean allowModify;
    ...
    public boolean contains(Object o) {
      if (!(o instanceof Map.Entry))
        return false;
      final Entry<Object,V> e = (Entry<Object,V>)o;
