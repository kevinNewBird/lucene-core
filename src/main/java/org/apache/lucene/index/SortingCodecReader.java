...
/**
 * An {@link CodecReader} which supports sorting documents by a given
...
public final class SortingCodecReader extends FilterCodecReader {
  ...
  /** Expert: same as {@link #wrap(CodecReader, Sort)} but operates directly on a {@link Sorter.DocMap}. */
